...
#
# Calculate individual Policy Download duration times
# Detect Changes (bool) for CSE Processing
# Estimate bandwidth for logon session
# DC and User Discovery durations
# DC Name being used for GPO & Script processing
...
$logonActivities | ForEach-Object {
    ...
    $XPath = "*[System[EventID=4001 or EventID=5257 or EventID=5016 or EventID=5017 or EventID=5314 or EventID=7016 or EventID=8001] and System[Correlation[@ActivityID='$ActivityID']]]"
    ...
    $GPOEvents | ForEach-Object {
        ...
        switch($eventID){
            4001 {$Action = "GPO Start"
                  ...
                  $WinlogonSearchStop = $StartPolicy.AddSeconds(2)
                  }
